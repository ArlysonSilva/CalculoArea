namespace CalculoArea
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            int x;
            Console.WriteLine("Vamos calcular a área de um retangulo:");
            ...
            c.CalculoArea();
            Console.WriteLine("Caso queira exibir o valor da àrea digite 1 caso queira ver os valores armazenados digite 2");
